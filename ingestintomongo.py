...
# --- Core MongoDB Upload Function (Modified to return status) ---
def upload_json_to_mongodb(file_path, mongo_uri, db_name, collection_name):
    ...
    try:
        ...
        if client:
            client.close()
            # print("Connection closed.") # Suppress for cleaner batch output

# --- New Batch Processing and File Movement Function ---
...
if __name__ == "__main__":
    ...
    # This is the folder structure where files will be picked from and moved to
    BASE_INGESTION_FOLDER = "MongoDB_JSON_Ingestion" 
    ...
    if config:
        ...
        try:
            ...
            # JSON_FILE_PATH is no longer needed here as the ingestion function handles it
            ...
            process_ingestion_with_file_move(BASE_INGESTION_FOLDER, MONGODB_URI, DATABASE_NAME, COLLECTION_NAME)
